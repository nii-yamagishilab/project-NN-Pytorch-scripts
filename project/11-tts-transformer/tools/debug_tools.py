...
def qw(data, path=None):
    ...
    # write to IO
    io_tools.f_write_raw_mat(convert_data_for_debug(data), path)
    return
...
class data_probe:
    ...
    def __init__(self):
        ...
        self.data_dump_method = io_tools.pickle_dump
    ...
    def dump(self, output_path='./debug/data_dump', add_time_tag=True):
        ...
        #    self.merge_data()
        #io_tools.f_write_raw_mat(self.data_concated, output_path_new)
