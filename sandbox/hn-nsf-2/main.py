...
def main():
    ...
    # prepare data io
    input_dirs = ['/home/smg/wang/WORK/WORK/DATA/CMU/slt/5ms/melspec',
                  '/home/smg/wang/WORK/WORK/DATA/CMU/slt/5ms/f0']
    input_dims = [80, 1]
    input_exts = ['.mfbsp', '.f0']
    input_reso = [80, 80]
    input_norm = [True, True]
    
    output_dirs = ['/home/smg/wang/WORK/WORK/DATA/CMU/slt/wav_16k']
    output_dims = [1]
    output_exts = ['.wav']
    output_reso = [1]
    output_norm = [False]
    ...
    if True:
        ...
        file_list = '/home/smg/wang/WORK/WORK/DATA/CMU/slt/scp/train.lst'
        file_list = nii_list_tool.read_list_from_text(file_list)
        trnset_wrapper = nii_data_io.NIIDataSetLoader("cmu_slt_trn", file_list,
        ...
        file_list = '/home/smg/wang/WORK/WORK/DATA/CMU/slt/scp/val.lst'
        file_list = nii_list_tool.read_list_from_text(file_list)
        valset_wrapper = nii_data_io.NIIDataSetLoader("cmu_slt_val", file_list,
                                                      input_dirs, input_exts, input_dims, 
                                                      input_reso, input_norm,
                                                      output_dirs, output_exts, output_dims, 
                                                      output_reso, output_norm,
        ...
        model = model.to(device, dtype=nii_dconf.d_dtype)
        ...
        params = {'batch_size':  1,
                  'shuffle': False,
                  'num_workers': 0}
        file_list = '/home/smg/wang/WORK/WORK/DATA/CMU/slt/scp/test.lst'
        file_list = nii_list_tool.read_list_from_text(file_list)[0:10]
        dataset_wrapper = nii_data_io.NIIDataSetLoader("cmu_slt_test_tiny", 
        ...
        nii_nn_wrapper.f_inference_wrapper(args, model, device, dataset_wrapper,
                                           checkpoint)
