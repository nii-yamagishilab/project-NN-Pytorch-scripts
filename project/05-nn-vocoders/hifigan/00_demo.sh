...
MODELLINK=https://zenodo.org/record/7476064/files/project-05-nn-vocoders-hifigan.tar
MODELNAME=project-05-nn-vocoders-hifigan
...
if [ ! -e "./__pre_trained/trained_network_G.pt" ];then
...
if [ -e "../DATA/${FILENAME}" ];then
    ...
    source ${ENVFILE}
    python main.py --num-workers 3 --no-best-epochs 50 --epochs 300 \
	   --batch-size 32 --lr 0.0005 --not-save-each-epoch\
