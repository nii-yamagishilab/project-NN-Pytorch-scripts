...
class SSLModel(torch_nn.Module):
    def __init__(self, opt, ssl_orig_output_dim, output_layer_idx=None):
...
class FrontEnd(torch_nn.Module):
    ...
    def __init__(self, mpath, ssl_out_dim, 
        ...
        self.ssl_model = SSLModel(1, ssl_out_dim, ssl_layer_indices)
        self.ssl_model2 = SSLModel(2, ssl_out_dim, ssl_layer_indices)
...
class Model(torch_nn.Module):
    ...
    def __init__(self, in_dim, out_dim, args, prj_conf, mean_std=None):
        ...
        ssl_front_end_path = None
        # prj_conf.ssl_front_end_path is None
