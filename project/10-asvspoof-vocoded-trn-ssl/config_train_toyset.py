...
# 
# path to the continually trained SSL model (it is downloaded by 01_download.sh)
# It will not be used by model-ID-B*
ssl_front_end_path = os.path.dirname(__file__) \
                     + '/../../../SSL_pretrained/wav2vec_ft2_vox_vocoded.pt'
# 
