...
def main():
    ...
    if True:
        ...
        file_list = nii_list_tool.read_list_from_text(file_list)[0:100]
        ...
        file_list = nii_list_tool.read_list_from_text(file_list)[0:20]
        ...
        model = self_model.Model(dataset_wrapper.get_in_dim(), \
                                 ...
                                 args)
        model.load_state_dict(torch.load("./epoch_012.pt")['state_dict'])
        model.to(device)
